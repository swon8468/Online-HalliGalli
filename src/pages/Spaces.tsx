...
export default function Spaces() {
  ...
  const copyAdminUrl = async () => {
    setError(''); setMessage('')
    if (await copyText(`${window.location.origin}/spaces/${slug}/admin`)) setMessage('관리 URL을 복사했어요.')
